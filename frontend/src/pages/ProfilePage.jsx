  ...
  return (
    <section className="mx-auto flex w-full max-w-3xl flex-col gap-6">
      <div className="surface-card p-6 sm:p-8">
        ...
        <h1 className="mt-3 text-3xl font-semibold text-slate-900">Complete the details other travelers may rely on</h1>
        ...
        <form onSubmit={handleSubmit} className="mt-8 grid gap-5">
          <div className="flex items-center gap-4">
            <img
              src={form.photoUrl || 'https://placehold.co/128x128?text=GG'}
            ...
            <div className="flex flex-col gap-3">
              <input
                ...
                className="text-sm text-slate-600 file:mr-4 file:rounded-full file:border-0 file:bg-slate-900 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-white"
              />
